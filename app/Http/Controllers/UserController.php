...
class UserController extends Controller
{
    ...
    public function getBlockedUsers(Request $request)
    {
        ...
        // Suponiendo que tienes una relación "blockedUsers" en el modelo User
        // que devuelve una colección de instancias de UserBlock o similar
        $blockedUsers = $user->blockedUsers()->with('blockedUser')->get()->map(function ($block) {
            return [
                'id' => $block->blockedUser->id,
                'name' => $block->blockedUser->name,
                'username' => $block->blockedUser->username,
                // Puedes incluir más campos aquí según necesites
            ];
        });
